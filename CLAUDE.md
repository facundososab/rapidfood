...
| Action | Skill |
|--------|-------|
| Implementing a Django module | `django-hexagonal-modular-architecture` |
| Creating or modifying a use case | `django-hexagonal-modular-architecture` |
| Adding a REST endpoint | `django-hexagonal-modular-architecture` |
| Creating a repository | `django-hexagonal-modular-architecture` |
| Modifying domain logic | `django-hexagonal-modular-architecture` |
| Reviewing hexagonal architecture | `django-hexagonal-modular-architecture` |
