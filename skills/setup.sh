#!/bin/bash
# Setup AI Skills for Easybook development
...
#   - GitHub Copilot: .github/skills/ symlink + copilot-instructions.md copy
#
# Usage:
...
show_help() {
    ...
    echo ""
    echo "Configure AI coding assistants for Easybook development."
    echo ""
    echo "Options:"
...
[ "$SETUP_COPILOT" = true ] && echo "  • GitHub Copilot: .github/skills/ + copilot-instructions.md"
echo ""
